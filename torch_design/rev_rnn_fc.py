...
class RNN_REV_Model(torch.nn.Module):
    ...
    def init_hidden(self, batch_size):
        ...
        rev_hidden = Variable(torch.zeros(self.num_layers, batch_size, self.hidden_size)).to(self.device)
        rev_cell = Variable(torch.zeros(self.num_layers, batch_size, self.hidden_size)).to(self.device)
